 ...
 */
val pgfpath = "COMMA/gfbridge/source/lfmtp2019/QuantifiedLex.pgf"  // relative to archivepath


val language = "QuantifiedLexEng"    // name of the concrete grammar used for parsing
...
def run() : Unit = {
  ...
  val bridge = new GfMmtBridge(parser, language, dpath ? "QuantifiedLex", Some(dpath ? "QuantifiedLexSemantics"))
